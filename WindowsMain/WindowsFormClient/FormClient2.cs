...
{
    public partial class FormClient2 : Form, IClient
    {
        ...
        void connectionMgr_EvtConnected()
        {
            ...
            loginCmd.VncList = new List<VncEntry>();
        ...
        private void AddWindow(Client.Model.WindowsModel wndPos)
        {
            ...
            mHolder.AddControl(new CustomWinForm.CustomControlHolder.ControlAttributes {
                Id = wndPos.WindowsId,
            ...
            mWindowsDic.Add(wndPos.WindowsId, wndPos.WindowsId);
